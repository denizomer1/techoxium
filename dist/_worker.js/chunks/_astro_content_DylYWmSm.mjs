...
import { o as objectType, h as dateType, n as numberType, f as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, z as escape, B as renderUniqueStylesheet, C as renderScriptElement, D as createHeadAndContent, a as renderComponent } from './astro/server_B-4SWSrX.mjs';
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_u5O9njcM.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CEsL9wiT.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://techoxium.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DZVp2Aft.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules__YVQ8sOv.mjs');
