...
import { o as objectType, g as dateType, n as numberType, f as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, c as createComponent, x as unescapeHTML, a as renderTemplate, z as escape, B as renderUniqueStylesheet, C as renderScriptElement, D as createHeadAndContent, r as renderComponent } from './astro/server_DCU9xl9x.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BmpBc9Og.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CDT2cDQs.mjs').then(n => n._);
